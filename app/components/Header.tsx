...
const Header = () => {
  return (
    <header className="bg-primary text-white  md:px-[120px] flex gap-x-1  items-center text-xs font-medium">
      {/* left Section */}
      
        {/* courses */}
        <div className="flex items-center mx-1">
          <button className="font-semibold h-[50px] flex items-center bg-[#A9D0D5] p-1 md:py-5 md:px-4 text-[#1A3254]">
            <svg
            ...
            <p className="text-[10px] md:text-lg ml-1 md:ml-[10px]">نمایش دوره‌ها</p>
          </button>
        </div>
        ...
        <div className="flex items-center mx-1">
          <div className="relative">
            <svg
              width="16"
              height="9"
              className="absolute bottom-[5.8px]"
              viewBox="0 0 16 9"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
                d="M9.41467 7.87227L15.504 1.64386C15.209 1.14363 14.793 0.729571 14.296 0.441634C13.799 0.153698 13.2379 0.00159591 12.6667 0H3.33334C2.76215 0.00159591 2.201 0.153698 1.70402 0.441634C1.20704 0.729571 0.790988 1.14363 0.496002 1.64386L6.58534 7.87227C6.96105 8.25499 7.46973 8.46986 8 8.46986C8.53028 8.46986 9.03895 8.25499 9.41467 7.87227Z"
                fill="#A9D0D5"
              />
            </svg>
            <svg
            ...
            >
              <path
                d="M15.9693 0.0969238L10.3573 5.83647C9.73158 6.47482 8.88383 6.83331 8 6.83331C7.11617 6.83331 6.26842 6.47482 5.64267 5.83647L0.0306667 0.0969238C0.0213333 0.204651 0 0.302151 0 0.409197V8.59101C0.00105857 9.49483 0.352588 10.3613 0.97748 11.0004C1.60237 11.6395 2.4496 11.999 3.33333 12.0001H12.6667C13.5504 11.999 14.3976 11.6395 15.0225 11.0004C15.6474 10.3613 15.9989 9.49483 16 8.59101V0.409197C16 0.302151 15.9787 0.204651 15.9693 0.0969238Z"
                fill="#A9D0D5"
              />
            </svg>
          </div>
          <p className="ml-[5px]"><span className="hidden md:block">Email: </span>pjsofts@gmail.com</p>
        </div>
